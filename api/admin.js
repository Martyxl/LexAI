...
<style>
  ...
  th{background:#1e3248;color:#fff;padding:11px 16px;text-align:left;font-size:12px;text-transform:uppercase;letter-spacing:.06em}
  td{padding:10px 16px;border-bottom:1px solid #e5e7eb;font-size:14px}
  tr:last-child td{border-bottom:none}tr:hover td{background:#f0f9ff}a{color:#2563eb}
</style></head><body>
<h1>LexAI — Kontakty</h1>

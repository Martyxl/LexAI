...
export default async function handler(req, res) {
  ...
  if (!kv) {
    return res.status(503).send('Vercel KV není nakonfigurováno.');
  }
...
<div class="meta">Celkem: <strong>${contacts.length}</strong> kontaktů</div>
<table>
  <thead><tr><th>Datum</th><th>Jméno</th><th>Email</th><th>Firma</th><th>Objem smluv</th></tr></thead>
